    ...
    <MainLayout>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container relative py-16 md:py-32 text-center px-4">
          <motion.h1
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 tracking-tight leading-[1.15] max-w-4xl mx-auto"
            variants={fadeUp}
            initial="hidden"
            animate="visible"
            custom={0}
          >
            Deixe o seu vídeo livre de direitos autorais<br /><span className="text-primary">com qualquer estilo de música.</span>
          </motion.h1>
          <motion.p
